...
public class NbBatSmallBlock extends MapRenderer {
	static String nameMap = "nbBatSmallBlock";
	static String text = "Nombre de bâtiments simulés de type 'petit immeuble collectif'";

	public NbBatSmallBlock(int imageWidth, int imageHeight, File rootMapstyle, File tomapshp, File outfolder) {
	...
	public static void main(String[] args) throws MalformedURLException, NoSuchAuthorityCodeException, IOException, FactoryException {
		...
		outMap.mkdirs();
		MapRenderer mpR = new NbBatSmallBlock(1000, 1000, rootMapStyle,
