...
public class NbHUMultiFamilyHouse extends MapRenderer {
	static String nameMap = "nbHUMultiFamilyHouse";
	static String text = "Nombre de logements simulés de type 'immeuble d'habitat intermédiaire'";

	public NbHUMultiFamilyHouse(int imageWidth, int imageHeight, File rootMapstyle, File tomapshp, File outfolder) {
	...
	public static void main(String[] args) throws MalformedURLException, NoSuchAuthorityCodeException, IOException, FactoryException {
		...
		outMap.mkdirs();
		MapRenderer mpR = new NbHUMultiFamilyHouse(1000, 1000, rootMapStyle,
