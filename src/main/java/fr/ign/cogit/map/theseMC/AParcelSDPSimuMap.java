...
//
//public class AParcelSDPSimuMap extends MapRenderer {
//	static String nameMap = "aParcelSDPSimuMap";
//
//	public AParcelSDPSimuMap(int imageWidth, int imageHeight, File rootMapstyle, File tomapshp, File outfolder) {
...
//		outMap.mkdirs();
//		MapRenderer mpR = new AParcelSDPSimuMap(1000, 1000, rootMapStyle,
