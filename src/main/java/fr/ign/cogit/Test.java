...
//		IFeatureCollection<IFeature> geox = ShapefileReader.read("/home/mcolomb/tmp/salut.shp");
//			
//		SimpleFeatureCollection geot = GeOxygeneGeoToolsTypes.convert2FeatureCollection(geox);
//		Vectors.exportSFC(geot, new File("/home/mcolomb/tmp/gtColl.shp"));
//		
		ShapefileDataStore morphoSDS = new ShapefileDataStore(new File("/home/mcolomb/tmp/salut.shp").toURI().toURL());
		SimpleFeatureCollection morphoSFC = morphoSDS.getFeatureSource().getFeatures();
//		Vectors.exportSFC(morphoSFC, new File("/home/mcolomb/tmp/gtCool.shp"));
		
		
		IFeatureCollection<?> geoxv = GeOxygeneGeoToolsTypes.convert2IFeatureCollection(morphoSFC);
		System.out.println(geoxv.getFeatureType().getFeatureAttributes());
		ShapefileWriter.write(geoxv, new File("/home/mcolomb/tmp/geoxColl.shp").toString(), CRS.decode("EPSG:2154"));
