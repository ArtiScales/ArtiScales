...
public class FakeZone {
	...
	public FakeZone(int shift, String libelle, double dx, double dy) {
		...
		IDirectPositionList dplFaceBuilding = new DirectPositionList(dpBuilding1, dpBuilding2, dpBuilding3, dpBuilding4,
				dpBuilding1);

		IGeometry geom = Extrusion2DObject.convertFromGeometry(new GM_Polygon(new GM_LineString(dplFaceBuilding)), 0,
				15);
