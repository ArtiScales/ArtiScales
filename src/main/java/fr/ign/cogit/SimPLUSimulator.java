...
import fr.ign.cogit.rules.PrescriptionPreparator;
import fr.ign.cogit.rules.ZoneRulesAssociation;
...
public class SimPLUSimulator {
	...
	public static void main(String[] args) throws Exception {
		...
		// String rootParam =
		// SimPLUSimulator.class.getClassLoader().getResource("paramSet/scenar0/").getPath();
	...
	public List<File> run() throws Exception {
		...
		// @TODO : on garde 1 fichier par bPU ? Tu t'en sors après ou c'est pas trop dur
		// ?
	...
	public File runSimulation(Environnement env, int i, Parameters p, IFeatureCollection<Prescription> prescriptionUse)
		...
		// conservé
		//
		// @TODO : c'est pas un peu bizarre ça ? Il suffit pas juste de passer 0 comme
		// paramètres pour i ?
