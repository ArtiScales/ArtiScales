...
import fr.ign.artiscales.pm.fields.artiscales.ArtiScalesParcelFields;
	...
	public static SimpleFeatureCollection runParcelRecomp(String splitZone, SimpleFeatureCollection bigZonedParcel, File tmpFolder, File mupOutput,
		...
		case "densification":
			...
			SimpleFeatureCollection toDensify = MarkParcelAttributeFromPosition.markParcelIntersectGenericZoningType(parcMUPMarked, splitZone,
					zoningFile);
			SimpleFeatureCollection salut = (new Densification()).densification(toDensify, ilot, tmpFolder, buildingFile, roadFile, profileUrbanFabric,
		...
		case "partRecomp":
			...
			SimpleFeatureCollection cuted = (new ConsolidationDivision()).consolidationDivision(test, null, tmpFolder, profileUrbanFabric);
		...
		case "totRecomp":
			...
			SimpleFeatureCollection parcelCuted = (new ZoneDivision()).zoneDivision(zone, bigZonedParcel, outFolder, profileUrbanFabric);
